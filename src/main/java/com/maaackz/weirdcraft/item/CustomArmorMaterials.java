...
public class CustomArmorMaterials {
    public static final RegistryEntry<ArmorMaterial> WEIRDIUM_ARMOR_MATERIAL = registerArmorMaterial("weirdium",
            ...
            }), 20, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, () -> Ingredient.ofItems(CustomItems.WEIRDIUM_INGOT),
                    List.of(new ArmorMaterial.Layer(Identifier.of(Weirdcraft.MOD_ID, "weirdium"))), 0,0));
