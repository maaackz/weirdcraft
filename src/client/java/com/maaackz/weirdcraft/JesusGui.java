...
public class JesusGui {
    ...
    private static Identifier image_id = Identifier.of("weirdcraft", "textures/gui/jesus0.png");
    ...
    public static void init() {
        for (int i = 0; i < NUMBEROFIMAGES; i++) {
            images.add(Identifier.of("weirdcraft", "textures/gui/jesus"+i+".png"));
        }
    }
    ...
    public static void display() {
        if (MinecraftClient.getInstance().world !=null && MinecraftClient.getInstance().player != null) {
            if (lastTime == -1 || System.currentTimeMillis() - lastTime > DISPLAY_DURATION *2) {
                ...
                playLocalSound(CustomSounds.JESUS_BELL_SOUND, MinecraftClient.getInstance().player);
            }
        }
    }
